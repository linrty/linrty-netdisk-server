package top.linrty.netdisk.common.domain.dto.user;
...
public class RegisterDTO {
    ...
    @Schema(description = "用户名", required = true, example = "netdisk")
    ...
    @Pattern(regexp = Constants.PHONE_REGEX, message = "手机号码输入有误")
    private String telephone;

    @Schema(description = "密码", required = true, example = "password123")
    @NotBlank(message = "密码不能为空")
    @Pattern(regexp = Constants.PASSWORD_REGEX, message = "密码长度6-20位,不允许中文")
